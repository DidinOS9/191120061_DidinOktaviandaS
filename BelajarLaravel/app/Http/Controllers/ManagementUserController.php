...
class ManagementUserController extends Controller
{
    public function index(){
        // return "Halo ini adalah method index, dalam controller ManagemenetUser.";
        // return "Method ini nantinya akan digunakan untuk mengambil semua data user";
        $nama = "Didin Oktavianda Setiawan";
    ...
    {
        return "Method ini nantinya akan digunkaan untuk menampilkan form unutk mengubah data edit dengan id=" . $id;
    }
